...
use velkar_core::{debug, time::unix_now, trace};
use std::{
...
impl TransactionsPool {
    pub(crate) fn new(config: Arc<Config>) -> Self {
        let target_time_per_block_seconds = config.target_time_per_block_seconds;
        Self {
            config,
            ...
            ready_transactions: Frontier::new(target_time_per_block_seconds),
