use velkar_consensus_core::constants::TX_VERSION;
...
pub struct Config {
    ...
    pub network_blocks_per_second: f64,
    pub target_time_per_block_seconds: f64,
}
...
impl Config {
    ...
    /// The arguments should be obtained from the current consensus [`velkar_consensus_core::config::params::Params`] instance.
    pub fn build_default(target_milliseconds_per_block: u64, relay_non_std_transactions: bool, max_block_mass: u64) -> Self {
        let target_time_per_block_seconds = target_milliseconds_per_block as f64 / 1000.0;
        Self {
            ...
            network_blocks_per_second: 1000.0 / target_milliseconds_per_block as f64,
            target_time_per_block_seconds,
        }
    }
