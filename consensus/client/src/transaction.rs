//!
//! Declares the client-side [`Transaction`] type, which represents a Velkar transaction.
//!
...
use velkar_consensus_core::network::NetworkTypeT;
use velkar_consensus_core::subnets::{self, SubnetworkId};
use velkar_consensus_core::tx::UtxoEntry;
...
impl Transaction {
    ...
    pub fn addresses(&self, network_type: &NetworkTypeT) -> Result<velkar_addresses::AddressArrayT> {
