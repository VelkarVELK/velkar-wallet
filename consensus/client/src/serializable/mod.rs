//!
//! # Standardized JSON serialization and deserialization of Velkar transactions.
//!
//! This module provides standardized JSON serialization and deserialization of
//! Velkar transactions. There are two sub-modules: `numeric` and `string`.
//!
...
//! For more advanced use cases, please refer to `PSKT` in the [`velkar_wallet_pskt`](https://docs.rs/velkar_wallet_pskt)
//! crate.
//!
