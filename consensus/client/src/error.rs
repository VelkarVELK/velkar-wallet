...
pub enum Error {
    ...
    #[error(transparent)]
    ScriptBuilder(#[from] velkar_txscript::script_builder::ScriptBuilderError),
    ...
    #[error(transparent)]
    Sign(#[from] velkar_consensus_core::sign::Error),
    ...
    #[error(transparent)]
    CompressedParents(#[from] velkar_consensus_core::errors::header::CompressedParentsError),
