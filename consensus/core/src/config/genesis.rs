...
use velkar_muhash::EMPTY_MUHASH;
...
pub const TESTNET_GENESIS: GenesisBlock = GenesisBlock {
    ...
    coinbase_payload: &[
        ...
        0x01,                                                                         // Varint
        0x00,                                                                         // OP-FALSE
        0x6b, 0x61, 0x73, 0x70, 0x61, 0x2d, 0x74, 0x65, 0x73, 0x74, 0x6e, 0x65, 0x74, // velkar-testnet
    ],
};

pub const VELKAR_GENESIS: GenesisBlock = GenesisBlock {
    hash: Hash::from_bytes([
        0x06, 0x0c, 0x5d, 0xcb, 0x4f, 0xb1, 0xdf, 0xa9, 0x9c, 0xdc, 0x1c, 0x6f, 0xdf, 0x1e, 0xf5, 0x33,
        0x6d, 0x22, 0x34, 0x30, 0xcd, 0x0d, 0xe7, 0x0e, 0x55, 0x66, 0x8a, 0x97, 0xfb, 0x1d, 0x41, 0x4e,
    ]),
    // Approximately difficulty 5,000 against VelkarHash: suitable for a
    // roughly 1 kH/s bootstrap miner to find the first block in about 10s.
    bits: 0x1f068db8,
    timestamp: 1_784_103_200_000,
    nonce: 0,
    ..TESTNET_GENESIS
};
...
pub const SIMNET_GENESIS: GenesisBlock = GenesisBlock {
    ...
    coinbase_payload: &[
        ...
        0x01,                                                                   // Varint
        0x00,                                                                   // OP-FALSE
        0x6b, 0x61, 0x73, 0x70, 0x61, 0x2d, 0x73, 0x69, 0x6d, 0x6e, 0x65, 0x74, // velkar-simnet
    ],
};
...
pub const DEVNET_GENESIS: GenesisBlock = GenesisBlock {
    ...
    bits: 0x1f5fffff, // Easier bootstrap bits for the CPU-hard VelkarHash dev/test startup
    nonce: 0x48e5e,
    daa_score: 0,
    #[rustfmt::skip]
    coinbase_payload: &[
        ...
        0x01,                                                                   // Varint
        0x00,                                                                   // OP-FALSE
        0x6b, 0x61, 0x73, 0x70, 0x61, 0x2d, 0x64, 0x65, 0x76, 0x6e, 0x65, 0x74, // velkar-devnet
    ],
};
...
mod tests {
    ...
    #[test]
    fn test_velkar_genesis_hash() {
        let block: Block = (&VELKAR_GENESIS).into();
        assert_hashes_eq(calc_hash_merkle_root(block.transactions.iter()), block.header.hash_merkle_root);
        assert_hashes_eq(block.hash(), VELKAR_GENESIS.hash);
    }
    ...
    fn gen_testnet11_genesis() {
        ...
        let target = velkar_math::Uint256::from_compact_target_bits(genesis.bits);
