pub use super::{
    bps::{Bps, TenBps},
    constants::consensus::*,
    genesis::{GenesisBlock, SIMNET_GENESIS, TESTNET_GENESIS, TESTNET11_GENESIS, VELKAR_GENESIS},
};
use crate::{
    BlockLevel, KType,
...
const fn velkar_blockrate_10s() -> BlockrateParams {
    BlockrateParams {
        ...
        merge_depth: Bps::<1>::merge_depth_bound() / 10,
        finality_depth: Bps::<1>::finality_depth() / 10,
        pruning_depth: Bps::<1>::pruning_depth() / 10,
        // Coinbase rewards show up as pending first and mature after 30 blocks.
        // At a 10-second target this is about 5 minutes.
...
pub struct OverrideParams {
    ...
    /// The parameter for scaling inverse VELK value to mass units (KIP-0009)
...
impl Params {
    ...
    /// Based on the analysis at <https://github.com/velkarnet/docs/blob/main/Reference/prunality/Prunality.pdf>
...
pub const MAINNET_PARAMS: Params = Params {
    dns_seeders: &["seed.velkar.org", "seed1.velkar.org", "seed2.velkar.org"],
    net: NetworkId::new(NetworkType::Mainnet),
    // Velkar uses a 10-second block target. The reset genesis uses an initial
    // target calibrated for a small CPU network; DAA takes over after bootstrap.
    genesis: VELKAR_GENESIS,
    ...
    // A 60-block sampled window is roughly ten minutes at the target rate.
    // Do not retarget during the first five minutes: a handful of lucky early
    // blocks must not send a new network into a difficulty spike.
    difficulty_window_size: 60,
    min_difficulty_window_size: 30,
    ...
    pre_deflationary_phase_base_subsidy: 2 * SOMPI_PER_VELKAR,
    skip_proof_of_work: false,
    max_block_level: 225,
    pruning_proof_m: 1000,

    blockrate: velkar_blockrate_10s(),

    pre_crescendo_target_time_per_block: 10_000,
...
pub const TESTNET_PARAMS: Params = Params {
    dns_seeders: &[
        ...
        "seeder1-testnet.velkard.net",
        // This DNS seeder is run by -gerri-
        "dnsseeder-velkar-testnet.x-con.at",
        // This DNS seeder is run by supertypo
        "n-testnet-10.velkar.ws",
    ],
...
pub const SIMNET_PARAMS: Params = Params {
    ...
    blockrate: velkar_blockrate_10s().increase_max_block_parents(64),
