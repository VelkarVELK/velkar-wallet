...
pub struct UtxoCell {
    ...
    pub plurality: u64,
    /// The amount of VELK (in sompis) locked in this UTXO
    pub amount: u64,
}
...
// `velkar_wallet_core::tx::mass::MassCalculator`
#[derive(Clone)]
...
pub fn calc_storage_mass(
    ...
    /*
        ...
        accumulating:
            1) outs_plurality = Î£ p(o)
            2) harmonic_outs  = Î£ [C * p(o)^2 / amount(o)]
    */
    ...
    */
    ...
    if relaxed_formula_path {
        // Each input i contributes C Â· p(i)^2 / amount(i)
    ...
    // (ins_plurality, sum_ins) =>  (Î£ plurality, Î£ amounts)
    ...
    // mean_ins = (Î£ amounts) / (Î£ plurality)
    let mean_ins = sum_ins / ins_plurality;

    // arithmetic_ins:  C Â· (|I| / A(I)) = |I| Â· (C / mean_ins)
...
mod tests {
    use super::*;
    use crate::{
        constants::{SOMPI_PER_VELKAR, STORAGE_MASS_PARAMETER},
        network::NetworkType,
    ...
    fn verify_utxo_plurality_limits() {
        /*
           Verify that for all networks, existing UTXO entries can never overflow the product CÂ·P^2 used
        ...
        */
        for net in NetworkType::iter() {
            ...
            // verify CÂ·P^2 can never overflow
    ...
    fn test_storage_mass_pluralities() {
        ...
        */
        let test_cases = vec![
            ...
            PluralityTestCase {
                name: "1:3; output index=1, plurality=2; VELK units",
                inputs_tx1: &[1000 * SOMPI_PER_VELKAR],
                outputs_tx1: &[200 * SOMPI_PER_VELKAR, 200 * SOMPI_PER_VELKAR, 200 * SOMPI_PER_VELKAR],
                inputs_tx2: &[1000 * SOMPI_PER_VELKAR],
                outputs_tx2: &[200 * SOMPI_PER_VELKAR, 400 * SOMPI_PER_VELKAR],
                plurality_index: Some(1),
                desired_plurality: Some(2),
                override_output: true,
                storage_mass_parameter: 10_u64.pow(12),
            ...
            PluralityTestCase {
                name: "1:2; output index=0, plurality=2; VELK units",
                inputs_tx1: &[1000 * SOMPI_PER_VELKAR],
                outputs_tx1: &[200 * SOMPI_PER_VELKAR, 200 * SOMPI_PER_VELKAR],
                inputs_tx2: &[1000 * SOMPI_PER_VELKAR],
                outputs_tx2: &[400 * SOMPI_PER_VELKAR],
                plurality_index: Some(0),
                desired_plurality: Some(2),
                override_output: true,
                storage_mass_parameter: 10_u64.pow(12),
            ...
            PluralityTestCase {
                name: "2:2; output index=0, plurality=2; VELK units",
                inputs_tx1: &[350 * SOMPI_PER_VELKAR, 500 * SOMPI_PER_VELKAR],
                outputs_tx1: &[200 * SOMPI_PER_VELKAR, 200 * SOMPI_PER_VELKAR],
                inputs_tx2: &[350 * SOMPI_PER_VELKAR, 500 * SOMPI_PER_VELKAR],
                outputs_tx2: &[400 * SOMPI_PER_VELKAR],
                plurality_index: Some(0),
                desired_plurality: Some(2),
                override_output: true,
            ...
            PluralityTestCase {
                name: "4:6; output index=0, plurality=3; VELK units",
                inputs_tx1: &[350 * SOMPI_PER_VELKAR, 500 * SOMPI_PER_VELKAR, 350 * SOMPI_PER_VELKAR, 500 * SOMPI_PER_VELKAR],
                outputs_tx1: &[
                    200 * SOMPI_PER_VELKAR,
                    200 * SOMPI_PER_VELKAR,
                    400 * SOMPI_PER_VELKAR,
                    250 * SOMPI_PER_VELKAR,
                    250 * SOMPI_PER_VELKAR,
                    250 * SOMPI_PER_VELKAR,
                ],
                inputs_tx2: &[350 * SOMPI_PER_VELKAR, 500 * SOMPI_PER_VELKAR, 350 * SOMPI_PER_VELKAR, 500 * SOMPI_PER_VELKAR],
                outputs_tx2: &[200 * SOMPI_PER_VELKAR, 200 * SOMPI_PER_VELKAR, 400 * SOMPI_PER_VELKAR, 750 * SOMPI_PER_VELKAR],
    ...
    fn test_storage_mass() {
        ...
        //
        // Assert the formula: max( 0 , CÂ·( |O|/H(O) - |I|/A(I) ) )
        //
        ...
        let base_value = 10_000 * SOMPI_PER_VELKAR;
        ...
        tx2.tx.outputs[0].value = 10 * SOMPI_PER_VELKAR;
        ...
        // Assert the formula: max( 0 , CÂ·( |O|/H(O) - |I|/H(I) ) )
