...
/// SompiPerVelkar is the number of sompi in one velkar (1 VELK).
pub const SOMPI_PER_VELKAR: u64 = 100_000_000;

/// The parameter for scaling inverse VELK value to mass units (KIP-0009)
pub const STORAGE_MASS_PARAMETER: u64 = SOMPI_PER_VELKAR * 10_000;
...
pub const MAX_SOMPI: u64 = 13_000_000 * SOMPI_PER_VELKAR;
