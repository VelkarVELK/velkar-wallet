...
use velkar_consensus_core::tx::ScriptPublicKey;
...
use velkar_consensus_notify::{notification::Notification, root::ConsensusNotificationRoot};
use velkar_consensusmanager::{ConsensusFactory, ConsensusInstance, DynConsensusCtl};
use velkar_core::{core::Core, service::Service};
...
impl TestConsensus {
    ...
    /// See `velkar_consensus_core::errors::block::RuleError` for the complete list of possible validation rules.
