...
use velkar_pow::{calc_block_level, calc_block_level_check_pow};
use velkar_utils::vec::VecExtensions;
...
impl ProofContext {
    ...
    fn from_proof(
        ...
        let (db_lifetime, db) = velkar_database::create_temp_db!(ConnBuilder::default().with_files_limit(10));
