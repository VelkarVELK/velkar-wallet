...
use velkar_database::prelude::*;
use velkar_hashes::Hash;
use velkar_utils::binary_heap::TopK;
...
impl PruningProofManager {
    ...
    fn proof_from_descriptor(&self, descriptor: &PruningProofDescriptor) -> PruningPointProof {
        ...
        let (_db_lifetime, temp_db) = velkar_database::create_temp_db!(ConnBuilder::default().with_files_limit(10));
