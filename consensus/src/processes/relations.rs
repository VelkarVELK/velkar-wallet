...
use velkar_database::prelude::{BatchDbWriter, DbWriter, DirectWriter, StoreError};
...
mod tests {
    ...
    use velkar_core::assert_match;
    use velkar_database::prelude::{CachePolicy, ConnBuilder};
    use velkar_database::{create_temp_db, prelude::MemoryWriter};
    use std::sync::Arc;
