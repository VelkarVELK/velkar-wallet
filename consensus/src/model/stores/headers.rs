...
use velkar_consensus_core::{BlockHasher, BlockLevel, header::Header};
use velkar_database::prelude::{BatchDbWriter, CachedDbAccess};
use velkar_database::prelude::{CachePolicy, DB};
use velkar_database::prelude::{StoreError, StoreResult};
...
struct Header2 {
    ...
    pub nonce: u64,
    pub daa_score: u64,
    pub blue_work: velkar_consensus_core::BlueWorkType,
    pub blue_score: u64,
