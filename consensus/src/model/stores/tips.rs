...
use velkar_database::prelude::CachedDbSetItem;
...
use velkar_database::prelude::{BatchDbWriter, DirectDbWriter};
...
mod tests {
    use super::*;
    use velkar_database::{create_temp_db, prelude::ConnBuilder};
