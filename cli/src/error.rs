...
use velkar_wallet_core::error::Error as WalletError;
...
pub enum Error {
    ...
    #[error(transparent)]
    WrpcError(#[from] velkar_wrpc_client::error::Error),

    #[error(transparent)]
    RpcError(#[from] velkar_rpc_core::RpcError),
    ...
    #[error(transparent)]
    Daemon(#[from] velkar_daemon::error::Error),
    ...
    #[error(transparent)]
    Bip32(#[from] velkar_bip32::Error),

    #[error("private key {0} already exists")]
    PrivateKeyAlreadyExists(String),

    #[error(transparent)]
    MetricsError(velkar_metrics_core::error::Error),

    #[error(transparent)]
    VelkarWalletKeys(#[from] velkar_wallet_keys::error::Error),

    #[error(transparent)]
    PskbLockScriptSigError(#[from] velkar_wallet_pskt::error::Error),
