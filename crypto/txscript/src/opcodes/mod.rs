...
use velkar_consensus_core::hashing::sighash::SigHashReusedValues;
use velkar_consensus_core::hashing::sighash_type::SigHashType;
use velkar_consensus_core::tx::VerifiableTransaction;
use velkar_utils::hex::FromHex;
...
opcode_list! {
    ...
    opcode OpIf<0x63, 1>(self, vm) {
        ...
        if vm.is_executing() {
            ...
            // the similar flow of go-velkard
...
mod test {
    ...
    use velkar_consensus_core::constants::{SOMPI_PER_VELKAR, TX_VERSION};
    ...
    fn make_mock_transaction(lock_time: u64) -> (VerifiableTransactionMock, TransactionInput, UtxoEntry) {
        let dummy_prev_out = TransactionOutpoint::new(velkar_hashes::Hash::from_u64_word(1), 1);
        ...
        let dummy_tx_out = TransactionOutput::new(SOMPI_PER_VELKAR, dummy_script_public_key);
    ...
    mod kip10 {
        ...
        use velkar_consensus_core::tx::MutableTransaction;
