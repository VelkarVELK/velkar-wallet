use crate::protowire::{velkard_request::Payload as RequestPayload, velkard_response::Payload as ResponsePayload, *};
...
pub enum VelkardPayloadOps {
    ...
    // The conversion from a notification ResponsePayload into VelkardPayloadOps fails.
}
}
