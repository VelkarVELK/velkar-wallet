...
from!(item: &velkar_rpc_core::RpcBalancesByAddressesEntry, protowire::RpcBalancesByAddressesEntry, {
...
try_from!(item: &protowire::RpcBalancesByAddressesEntry, velkar_rpc_core::RpcBalancesByAddressesEntry, {
