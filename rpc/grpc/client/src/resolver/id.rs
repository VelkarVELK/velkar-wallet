use crate::{
    error::{Error, Result},
    resolver::{VelkardResponseReceiver, VelkardResponseSender, Resolver},
};
...
impl Pending {
    fn new(sender: VelkardResponseSender) -> Self {
...
impl Resolver for IdResolver {
    fn register_request(&self, _: VelkardPayloadOps, request: &VelkardRequest) -> VelkardResponseReceiver {
