...
use velkar_addresses::{Address, AddressError};
...
use velkar_consensus_notify::notification::{self as consensus_notify, Notification as ConsensusNotification};
use velkar_consensusmanager::{ConsensusManager, ConsensusProxy};
use velkar_hashes::Hash;
use velkar_math::Uint256;
use velkar_mining::model::{TransactionIdSet, owner_txs::OwnerTransactions};
use velkar_notify::converter::Converter;
use velkar_rpc_core::{
...
use velkar_txscript::{extract_script_pub_key_address, script_class::ScriptClass};
...
impl ConsensusConverter {
    ...
    ///
    /// _GO-VELKARD: PopulateBlockWithVerboseData_
    ...
    ///
    /// _GO-VELKARD: PopulateTransactionWithVerboseData
