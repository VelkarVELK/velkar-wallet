//! [`Resolver`](NativeResolver) bindings for obtaining public Velkar wRPC URL endpoints.
...
use crate::imports::*;
use js_sys::Array;
pub use velkar_rpc_macros::declare_typescript_wasm_interface as declare;
use velkar_wrpc_client::Resolver as NativeResolver;
use velkar_wrpc_client::node::NodeDescriptor;
use serde::ser;
...
///
/// Resolver is a client for obtaining public Velkar wRPC URL.
///
/// Resolver queries a list of public Velkar Resolver URLs using HTTP to fetch
...
#[wasm_bindgen]
impl Resolver {
    /// List of public Velkar Resolver URLs.
    #[wasm_bindgen(getter)]
    ...
    /// Fetches a public Velkar wRPC endpoint for the given encoding and network identifier.
    ...
    /// Fetches a public Velkar wRPC endpoint URL for the given encoding and network identifier.
    ...
    /// Connect to a public Velkar wRPC endpoint for the given encoding and network identifier
