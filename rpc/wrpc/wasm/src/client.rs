//!
//! # WASM bindings for the [Velkar p2p Node RPC client](VelkarRpcClient).
//!
//! This module provides a WASM interface for the Velkar p2p Node RPC client
//! - [`RpcClient`].
//!
...
use velkar_addresses::{Address, AddressOrStringArrayT};
use velkar_consensus_client::UtxoEntryReference;
use velkar_consensus_core::network::{NetworkType, NetworkTypeT};
use velkar_notify::connection::ChannelType;
use velkar_notify::events::EventType;
use velkar_notify::listener;
use velkar_notify::notification::Notification as NotificationT;
use velkar_rpc_core::api::ctl;
pub use velkar_rpc_core::wasm::message::*;
pub use velkar_rpc_macros::{
    build_wrpc_wasm_bindgen_interface, build_wrpc_wasm_bindgen_subscriptions, declare_typescript_wasm_interface as declare,
};
use velkar_wasm_core::events::{Sink, get_event_targets};
...
pub(crate) struct Inner {
    ...
    notification_channel: Channel<velkar_rpc_core::Notification>,
}
...
///
///
/// Velkar RPC client uses ([wRPC](https://github.com/workflow-rs/workflow-rs/tree/master/rpc))
/// interface to connect directly with Velkar Node. wRPC supports
/// two types of encodings: `borsh` (binary, default) and `json`.
///
/// There are two ways to connect: Directly to any Velkar Node or to a
...
/// ```
///
/// **Connecting to a Velkar Node directly**
///
/// ```javascript
/// let rpc = new RpcClient({
...
/// to re-register event listeners, but your have to re-subscribe for Velkar node
/// notifications:
///
/// ```typescript
/// rpc.addEventListener("connect", async (event) => {
...
impl RpcClient {
    pub fn new(config: Option<RpcConfig>) -> Result<RpcClient> {
        ...
        let client = Arc::new(
            VelkarRpcClient::new(encoding, url.as_deref(), resolver.clone().map(Into::into), network_id, None)
...
impl RpcClient {
    ...
    /// Connect to the Velkar RPC server. This function starts a background
    ...
    /// Disconnect from the Velkar RPC server.
    ...
    /// however, you have to re-subscribe for Velkar node notifications. As such, it is recommended
...
impl RpcClient {
    pub fn new_with_rpc_client(client: Arc<VelkarRpcClient>) -> RpcClient {
    ...
    pub fn client(&self) -> &Arc<VelkarRpcClient> {
        &self.inner.client
    }
                ...
                select_biased! {
                    ...
                    msg = notification_receiver.recv().fuse() => {
                        if let Ok(notification) = &msg {
                            match &notification {
                                velkar_rpc_core::Notification::UtxosChanged(utxos_changed_notification) => {
...
impl RpcClient {
    ...
    pub fn parse_url(url: &str, encoding: Encoding, network: NetworkId) -> Result<String> {
        let url_ = VelkarRpcClient::parse_url(url.to_string(), encoding, network.into())?;
        Ok(url_)
    }
}
...
impl RpcClient {
    ...
    /// Difficulty Adjustment Algorithm (DAA) score changes in the Velkar BlockDAG.
    ...
    /// Velkar BlockDAG. The event notification will be scoped to the
    ...
    /// chain changes in the Velkar BlockDAG.
...
build_wrpc_wasm_bindgen_subscriptions!([
    ...
    /// block is added to the Velkar BlockDAG.
    BlockAdded,
    ...
    /// conflict occurs in the Velkar BlockDAG.
    FinalityConflict,
    ...
    /// conflict in the Velkar BlockDAG is resolved.
    ...
    /// score of the sink block changes in the Velkar BlockDAG.
    ...
    /// UTXO set override for the pruning point changes in the Velkar BlockDAG.
    ...
    /// template is generated for mining in the Velkar BlockDAG.
    NewBlockTemplate,
]);
...
build_wrpc_wasm_bindgen_interface!(
    [
        ...
        /// Retrieves the current number of blocks in the Velkar BlockDAG.
        ...
        /// structure of the Velkar BlockDAG.
        ...
        GetBlockDagInfo,
        /// Returns the total current coin supply of Velkar network.
        /// Returned information: Total coin supply.
        GetCoinSupply,
        /// Retrieves information about the peers connected to the Velkar node.
        /// Returned information: Peer ID, IP address and port, connection
        /// status, protocol version.
        GetConnectedPeerInfo,
        /// Retrieves general information about the Velkar node.
        /// Returned information: Version of the Velkar node, protocol
        /// version, network identifier.
        /// This call is primarily used by gRPC clients.
        /// For wRPC clients, use {@link RpcClient.getServerInfo}.
        GetInfo,
        /// Provides a list of addresses of known peers in the Velkar
        ...
        /// performance and status of the Velkar node.
        ...
        /// the highest cumulative difficulty in the Velkar BlockDAG.
        ...
        GetSinkBlueScore,
        /// Tests the connection and responsiveness of a Velkar node.
        /// Returned information: None.
        Ping,
        /// Gracefully shuts down the Velkar node.
        /// Returned information: None.
        Shutdown,
        /// Retrieves information about the Velkar server.
        /// Returned information: Version of the Velkar server, protocol
        /// version, network identifier.
        GetServerInfo,
        /// Obtains basic information about the synchronization status of the Velkar node.
    ...
    [
        ...
        /// Adds a peer to the Velkar node's list of known peers.
        /// Returned information: None.
        AddPeer,
        /// Bans a peer from connecting to the Velkar node for a specified duration.
        /// Returned information: None.
        Ban,
        ...
        /// Retrieves the balance of a specific address in the Velkar BlockDAG.
        /// Returned information: Balance of the address.
        GetBalanceByAddress,
        /// Retrieves balances for multiple addresses in the Velkar BlockDAG.
        /// Returned information: Balances of the addresses.
        GetBalancesByAddresses,
        /// Retrieves a specific block from the Velkar BlockDAG.
        /// Returned information: Block information.
        GetBlock,
        /// Retrieves multiple blocks from the Velkar BlockDAG.
        ...
        /// Retrieves block headers from the Velkar BlockDAG.
        /// Returned information: List of block headers.
        GetHeaders,
        /// Retrieves mempool entries from the Velkar node's mempool.
        ...
        GetMempoolEntry,
        /// Retrieves information about a subnetwork in the Velkar BlockDAG.
        ...
        /// Resolves a finality conflict in the Velkar BlockDAG.
        /// Returned information: None.
        ResolveFinalityConflict,
        /// Submits a block to the Velkar network.
        /// Returned information: None.
        SubmitBlock,
        /// Submits a transaction to the Velkar network.
        /// Returned information: Submitted Transaction Id.
        SubmitTransaction,
        /// Submits an RBF transaction to the Velkar network.
