...
pub enum RpcApiOps {
    ...
    GetSyncStatus = 115,
    /// Returns the network this Velkard is connected to (Mainnet, Testnet)
    ...
    /// Returns a list of all the addresses (IP, port) this Velkard knows and a list of all addresses that are currently banned by this Velkard
    ...
    /// Returns a list of the peers currently connected to this Velkard, along with some statistics on them
    GetConnectedPeerInfo = 123,
    /// Instructs Velkard to connect to a given IP address.
    AddPeer = 124,
