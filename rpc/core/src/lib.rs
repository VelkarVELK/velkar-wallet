//! # RPC Core
//!
//! This crate provides foundational primitives used in Rusty Velkar node RPC subsystem.
...
//!
//! This crate acts as a foundation for [`velkar_grpc_client`](https://docs.rs/velkar_grpc_client) and
//! [`velkar_wrpc_client`](https://docs.rs/velkar_wrpc_client) crates, which provide gRPC and WebSocket
//! RPC client implementations. This crate is also used by WASM bindings to provide [WASM RpcClient
//! implementation](https://docs.rs/velkar-wrpc-client/latest/velkar_wrpc_client/wasm/struct.RpcClient.html)
//! (based on wRPC).
//!
