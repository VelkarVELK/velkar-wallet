...
use velkar_utils::networking::IpAddress;
...
pub enum RpcError {
    ...
    #[error(transparent)]
    AddressError(#[from] velkar_addresses::AddressError),

    #[error(transparent)]
    NetworkTypeError(#[from] velkar_consensus_core::network::NetworkTypeError),

    #[error(transparent)]
    NetworkIdError(#[from] velkar_consensus_core::network::NetworkIdError),

    #[error(transparent)]
    NotificationError(#[from] velkar_notify::error::Error),

    #[error(transparent)]
    MiningManagerError(#[from] velkar_mining_errors::manager::MiningManagerError),

    #[error(transparent)]
    ConsensusError(#[from] velkar_consensus_core::errors::consensus::ConsensusError),

    #[error(transparent)]
    ScriptClassError(#[from] velkar_txscript::script_class::Error),
