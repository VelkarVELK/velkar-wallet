...
use velkar_utils::{hex::ToHex, serde_bytes_fixed_ref, serde_bytes_fixed_ref_optional, serde_bytes_optional};
...
impl From<velkar_consensus_client::TransactionOutpoint> for RpcOptionalTransactionOutpoint {
    fn from(outpoint: velkar_consensus_client::TransactionOutpoint) -> Self {
        TransactionOutpoint::from(outpoint).into()
    }
}

impl TryFrom<RpcOptionalTransactionOutpoint> for velkar_consensus_client::TransactionOutpoint {
    type Error = RpcError;
...
/// Represent Velkar transaction input verbose data
...
/// Represent Velkar transaction output verbose data
#[derive(Clone, Debug, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
...
/// Represent Velkar transaction verbose data
#[derive(Clone, Debug, Serialize, Deserialize)]
#[serde(rename_all = "camelCase")]
