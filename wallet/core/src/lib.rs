...
//! <https://velkar.aspectron.org/docs/>
//!
...
//! the `velkar` module includes `websocket` module dependency simulating
//! the W3C WebSocket and thus supports RPC.
//!
//! JavaScript examples for using this framework can be found at:
//! <https://github.com/velkar/velkar/tree/master/wasm/nodejs>
//!
//! For pre-built browser-compatible WASM32 redistributables of this
//! framework please see the releases section of the Velkar
//! repository at <https://github.com/velkar/velkar/releases>.
//!

extern crate alloc;
extern crate self as velkar_wallet_core;
...
pub fn version_with_git_hash() -> String {
    velkar_utils::git::with_short_hash(env!("CARGO_PKG_VERSION")).to_string()
}
