...
use velkar_bip32::Error as BIP32Error;
use velkar_consensus_core::sign::Error as CoreSignError;
use velkar_rpc_core::RpcError as VelkarRpcError;
use velkar_wrpc_client::error::Error as VelkarWorkflowRpcError;
...
pub enum Error {
    ...
    #[error(transparent)]
    WalletKeys(#[from] velkar_wallet_keys::error::Error),

    #[error("please select an account")]
    AccountSelection,

    #[error("{0}")]
    VelkarRpcClientResult(#[from] VelkarRpcError),

    #[error("wRPC -> {0}")]
    RpcError(#[from] RpcError),

    #[error("Wallet wRPC -> {0}")]
    VelkarWorkflowRpcError(#[from] VelkarWorkflowRpcError),
    ...
    #[error("{0}")]
    NetworkType(#[from] velkar_consensus_core::network::NetworkTypeError),

    #[error("{0}")]
    NetworkId(#[from] velkar_consensus_core::network::NetworkIdError),
    ...
    #[error(transparent)]
    Address(#[from] velkar_addresses::AddressError),
    ...
    #[error(transparent)]
    ScriptBuilderError(#[from] velkar_txscript::script_builder::ScriptBuilderError),
    ...
    #[error(transparent)]
    ConsensusClient(#[from] velkar_consensus_client::error::Error),

    #[error(transparent)]
    ConsensusWasm(#[from] velkar_consensus_wasm::error::Error),
    ...
    #[error(transparent)]
    MultisigCreateError(#[from] velkar_txscript::MultisigCreateError),

    #[error(transparent)]
    TxScriptError(#[from] velkar_txscript_errors::TxScriptError),
    ...
    #[error(transparent)]
    Metrics(#[from] velkar_metrics_core::error::Error),

    #[error("Connected node is not synced")]
    NotSynced,
    #[error(transparent)]
    Pskt(#[from] velkar_wallet_pskt::error::Error),
