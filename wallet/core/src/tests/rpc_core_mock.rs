...
use velkar_notify::events::EVENT_TYPE_ARRAY;
use velkar_notify::listener::{ListenerId, ListenerLifespan};
use velkar_notify::notifier::{Notifier, Notify};
use velkar_notify::scope::Scope;
...
use velkar_rpc_core::api::ctl::RpcCtl;
use velkar_rpc_core::{RpcResult, notify::connection::ChannelConnection};
use velkar_rpc_core::{api::connection::DynRpcConnection, api::rpc::RpcApi, *};
use std::sync::Arc;
...
impl RpcCoreMock {
    ...
    #[allow(dead_code)]
    pub fn notify_new_block_template(&self) -> velkar_notify::error::Result<()> {
