...
use velkar_consensus_core::network::NetworkIdT;
use velkar_wallet_macros::declare_typescript_wasm_interface as declare;
use velkar_wasm_core::events::{Sink, get_event_targets};
use velkar_wrpc_wasm::{IConnectOptions, Resolver, RpcClient, RpcConfig, WrpcEncoding};
...
///
/// The Rusty Velkar is developed in Rust, and the Wallet class is a Rust implementation
