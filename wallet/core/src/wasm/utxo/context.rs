...
use velkar_addresses::AddressOrStringArrayT;
use velkar_consensus_client::UtxoEntryReferenceArrayT;
...
/// on the Velkar network.  When an address is registered with UtxoContext
