...
use js_sys::Array;
use velkar_consensus_client::{Transaction, sign_with_multiple_v3};
use velkar_consensus_core::hashing::wasm::SighashType;
use velkar_consensus_core::sign::sign_input;
use velkar_consensus_core::tx::PopulatedTransaction;
use velkar_consensus_core::{hashing::sighash_type::SIG_HASH_ALL, sign::verify};
use velkar_hashes::Hash;
use velkar_wallet_keys::privatekey::PrivateKey;
use velkar_wasm_core::types::HexString;
