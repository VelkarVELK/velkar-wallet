//!
//! Legacy (KDX, velkarnet.io Web Wallet) account implementation
//!

use crate::account::{AsLegacyAccount, Inner};
use crate::derivation::{AddressDerivationManager, AddressDerivationManagerTrait};
use crate::imports::*;
use velkar_bip32::{ExtendedPrivateKey, Prefix, SecretKey};

const CACHE_ADDRESS_OFFSET: u32 = 2048;

pub const LEGACY_ACCOUNT_KIND: &str = "velkar-legacy-standard";
...
impl Factory for Ctor {
    ...
    fn description(&self) -> String {
        "Velkar Legacy Account (KDX, velkarnet.io Web Wallet)".to_string()
    }
