...
/// This class accepts the master Velkar XPrv string (e.g. `xprv1...`) and generates
...
///
/// Please note that in Velkar master private keys use `kprv` prefix.
///
