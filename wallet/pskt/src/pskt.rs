//!
//! Partially Signed Velkar Transaction (PSKT)
//!

use velkar_bip32::{DerivationPath, KeyFingerprint, secp256k1};
use velkar_consensus_core::{Hash, hashing::sighash::SigHashReusedValuesUnsync};
...
use velkar_consensus_core::mass::{MassCalculator, NonContextualMasses};
...
use velkar_txscript::{TxScriptEngine, caches::Cache};
...
pub struct KeySource {
    #[serde(with = "velkar_utils::serde_bytes_fixed")]
...
///
/// A Partially Signed Velkar Transaction (PSKT) is a standardized format
/// that allows multiple participants to collaborate in creating and signing
/// a Velkar transaction. PSKT enables the exchange of incomplete transaction
