...
//! the [`velkar_consensus_client`], [`velkar_consensus_core`]
//! and [`velkar_wallet_pskt`](crate) types.
//!
...
use velkar_consensus_client::{Transaction, TransactionInput, TransactionInputInner, TransactionOutput, TransactionOutputInner};
