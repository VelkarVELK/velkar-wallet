use velkar_consensus_core::config::params::TESTNET_PARAMS;
use velkar_consensus_core::{
    hashing::sighash::{SigHashReusedValuesUnsync, calc_schnorr_signature_hash},
    tx::{TransactionId, TransactionOutpoint, UtxoEntry},
};
use velkar_txscript::{multisig_redeem_script, opcodes::codes::OpData65, pay_to_script_hash_script, script_builder::ScriptBuilder};
use velkar_wallet_pskt::prelude::{
