# Contributing to Velkar

Thanks for your interest in contributing to Velkar!
...
Follow along the R&D Telegram group [@velkarrnd](https://t.me/velkarrnd).
...
2. Fork the repo (See [Installation](https://github.com/velkarnet/velkar?tab=readme-ov-file#installation) guide) and create a feature branch with a short, descriptive name.
...
Thanks for helping make Velkar better. If you have questions, reach out to the channels described at the top of this document
