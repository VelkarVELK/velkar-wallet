...
macro_rules! trace {
    ($($t:tt)*) => {
        if velkar_core::log::workflow_log::log_level_enabled(log::Level::Trace) {
            velkar_core::log::workflow_log::impls::trace_impl(None, &format_args!($($t)*));
        }
    };
}
...
macro_rules! debug {
    ($($t:tt)*) => (
        if velkar_core::log::workflow_log::log_level_enabled(log::Level::Debug) {
            velkar_core::log::workflow_log::impls::debug_impl(None, &format_args!($($t)*));
        }
    )
}
...
macro_rules! info {
    ($($t:tt)*) => (
        if velkar_core::log::workflow_log::log_level_enabled(log::Level::Info) {
            velkar_core::log::workflow_log::impls::info_impl(None, &format_args!($($t)*));
        }
    )
}
...
macro_rules! warn {
    ($($t:tt)*) => (
        if velkar_core::log::workflow_log::log_level_enabled(log::Level::Warn) {
            velkar_core::log::workflow_log::impls::warn_impl(None, &format_args!($($t)*));
        }
    )
}
...
macro_rules! error {
    ($($t:tt)*) => (
        if velkar_core::log::workflow_log::log_level_enabled(log::Level::Error) {
            velkar_core::log::workflow_log::impls::error_impl(None, &format_args!($($t)*));
        }
    )
}
