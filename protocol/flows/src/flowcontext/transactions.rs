...
use velkar_p2p_lib::{
    Hub, make_message,
    pb::{InvTransactionsMessage, VelkardMessage, velkard_message::Payload},
};
...
impl TransactionsSpread {
    ...
    /// capacity.
    ///
    /// _GO-VELKARD: EnqueueTransactionIDsForPropagation_
    ...
    async fn broadcast(&self, msg: VelkardMessage, should_throttle: bool) {
        if should_throttle {
