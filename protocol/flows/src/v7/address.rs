...
use velkar_addressmanager::NetAddress;
use velkar_p2p_lib::{
    IncomingRoute, Router,
    common::ProtocolError,
    dequeue, dequeue_with_timeout, make_message,
    pb::{AddressesMessage, RequestAddressesMessage, velkard_message::Payload},
};
use velkar_utils::networking::IpAddress;
use rand::seq::SliceRandom;
use std::sync::Arc;

/// The maximum number of addresses that are sent in a single velkar Addresses message.
const MAX_ADDRESSES_SEND: usize = 1000;

/// The maximum number of addresses that can be received in a single velkar Addresses response.
