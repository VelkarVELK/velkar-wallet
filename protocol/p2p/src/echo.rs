use crate::{
    IncomingRoute, VelkardMessagePayloadType, Router,
    common::ProtocolError,
    core::adaptor::ConnectionInitializer,
    handshake::VelkardHandshake,
    pb::{self, VersionMessage},
};
use velkar_core::{debug, time::unix_now, trace, warn};
use std::sync::Arc;
...
impl EchoFlow {
    pub async fn register(router: Arc<Router>) {
        ...
        let receiver = router.subscribe(vec![
            VelkardMessagePayloadType::Addresses,
            VelkardMessagePayloadType::Block,
            VelkardMessagePayloadType::Transaction,
            VelkardMessagePayloadType::BlockLocator,
            VelkardMessagePayloadType::RequestAddresses,
            VelkardMessagePayloadType::RequestRelayBlocks,
            VelkardMessagePayloadType::RequestTransactions,
            VelkardMessagePayloadType::IbdBlock,
            VelkardMessagePayloadType::InvRelayBlock,
            VelkardMessagePayloadType::InvTransactions,
            VelkardMessagePayloadType::Ping,
            VelkardMessagePayloadType::Pong,
            // VelkardMessagePayloadType::Verack,
            // VelkardMessagePayloadType::Version,
            // VelkardMessagePayloadType::Ready,
            VelkardMessagePayloadType::TransactionNotFound,
            VelkardMessagePayloadType::Reject,
            VelkardMessagePayloadType::PruningPointUtxoSetChunk,
            VelkardMessagePayloadType::RequestIbdBlocks,
            ...
            VelkardMessagePayloadType::RequestNextHeaders,
            VelkardMessagePayloadType::DoneHeaders,
            VelkardMessagePayloadType::RequestPruningPointUtxoSet,
            VelkardMessagePayloadType::RequestHeaders,
            VelkardMessagePayloadType::RequestBlockLocator,
            VelkardMessagePayloadType::PruningPoints,
            VelkardMessagePayloadType::RequestPruningPointProof,
            ...
            VelkardMessagePayloadType::RequestIbdChainBlockLocator,
            VelkardMessagePayloadType::IbdChainBlockLocator,
            VelkardMessagePayloadType::RequestAntipast,
    ...
    async fn call(&self, msg: pb::VelkardMessage) -> bool {
        // echo
...
fn build_dummy_version_message() -> VersionMessage {
    pb::VersionMessage {
        ...
        subnetwork_id: None,
        network: "velkar-mainnet".to_string(),
    }
}
...
impl ConnectionInitializer for EchoFlowInitializer {
    async fn initialize_connection(&self, router: Arc<Router>) -> Result<(), ProtocolError> {
        //
        // Example code to illustrate velkar P2P handshaking
        //

        // Build the handshake object and subscribe to handshake messages
        let mut handshake = VelkardHandshake::new(&router);
...
mod tests {
    ...
    use velkar_utils::networking::NetAddress;

    #[tokio::test]
    async fn test_handshake() {
        velkar_core::log::try_init_logger("debug");
