...
use velkar_p2p_lib::echo::EchoFlowInitializer;
...
async fn main() {
    // [-] - init logger
    velkar_core::log::init_logger(None, "debug");
    ...
    let adaptor = velkar_p2p_lib::Adaptor::bidirectional(ip_port, velkar_p2p_lib::Hub::new(), initializer, Default::default()).unwrap();
