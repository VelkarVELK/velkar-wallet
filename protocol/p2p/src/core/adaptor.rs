...
/// The main object to create for managing a fully-fledged Velkar P2P peer
pub struct Adaptor {
    //
...
impl Adaptor {
    ...
    /// Creates a P2P adaptor with only client-side support. Typical Velkar nodes should use `Adaptor::bidirectional`
