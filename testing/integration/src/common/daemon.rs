use velkar_consensus_core::network::NetworkId;
use velkar_core::{core::Core, signals::Shutdown, task::runtime::AsyncRuntime};
...
use velkar_utils::{networking::ContextualNetAddress, triggers::Listener};
use velkard_lib::{args::Args, daemon::create_core_with_runtime};
use parking_lot::RwLock;
use std::{ops::Deref, sync::Arc, time::Duration};
use tempfile::TempDir;

use velkar_grpc_client::ClientPool;
...
impl Daemon {
    ...
    pub fn with_manager(client_manager: Arc<ClientManager>, fd_total_budget: i32) -> Daemon {
        let appdir_tempdir = get_velkar_tempdir();
