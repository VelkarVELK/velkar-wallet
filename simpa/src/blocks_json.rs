...
use velkar_consensus::{consensus::Consensus, params::OverrideParams};
use velkar_consensus_core::{api::ConsensusApi, block::Block};
use velkar_testing_integration::common::json::JtfBlock;
...
pub(crate) fn write_blocks_json(params: &Params, consensus: &Consensus, file_path: &str) {
    ...
    write_velkard_params(params, &mut writer);
...
fn write_velkard_params<W: Write>(params: &Params, writer: &mut W) {
