...
use velkar_consensus::config::Config;
...
use velkar_database::{create_permanent_db, create_temp_db};
use velkar_utils::fd_budget;
use velkar_utils::sim::Simulation;

type ConsensusWrapper = (Arc<Consensus>, Vec<JoinHandle<()>>, DbLifetime);

pub struct VelkarNetworkSimulator {
