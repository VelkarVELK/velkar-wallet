...
use velkar_consensus::consensus::Consensus;
use velkar_consensus::model::stores::virtual_state::VirtualStateStoreReader;
use velkar_consensus::params::Params;
use velkar_consensus_core::api::ConsensusApi;
use velkar_consensus_core::block::{Block, TemplateBuildMode, TemplateTransactionSelector};
use velkar_consensus_core::coinbase::MinerData;
use velkar_consensus_core::mass::MassCalculator;
use velkar_consensus_core::sign::sign;
...
use velkar_consensus_core::utxo::utxo_view::UtxoView;
use velkar_core::trace;
use velkar_utils::sim::{Environment, Process, Resumption, Suspension};
use rand::Rng;
...
impl TemplateTransactionSelector for OnetimeTxSelector {
    ...
    fn reject_selection(&mut self, _tx_id: velkar_consensus_core::tx::TransactionId) {
        unimplemented!()
    }
