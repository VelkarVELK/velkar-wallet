Latest online documentation available at: https://velkar.aspectron.org/docs/
...
- Merge with Rusty Velkar master (0.13.6)
...
- Rename `velkar-beacon` app to `velkar-resolver`
...
- Introduced `Beacon` class that provides connectivity to the community-operated public node infrastructure (backed by `velkar-beacon` load balancer & node status monitor)
...
- Changed documentation structure to use `typedoc` available as a part of redistributables or online at https://velkar.aspectron.org/docs/
