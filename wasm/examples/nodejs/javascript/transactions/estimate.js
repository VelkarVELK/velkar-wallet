...
(async () => {
    ...
    console.info(`Full velkar address: ${sourceAddress}`);
    ...
    if (!entries.length) {
        ...
        //
        // If the requested amount is greater than the Velkar
        ...
        let generator = new Generator({
            entries,
            outputs: [{ address : sourceAddress, amount : velkarToSompi(0.2)}],
            priorityFee: velkarToSompi(0.0001),
