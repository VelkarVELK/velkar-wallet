...
const velkar = require('../velkar/velkar_wasm');
...
velkar.init_console_panic_hook();
...
(async () => {
    ...
    //     extraData:[],
    //     payAddress:"velkar:qrwee7xc2qw5whq8qzv82qjld6zunwy46lsy3hueej5kvgfwvamhswy03lsyh"
    // });
    ...
    const addr = address ?? "velkartest:qz7ulu4c25dh7fzec9zjyrmlhnkzrg4wmf89q7gzr3gfrsj3uz6xjceef60sd";

    const addresses = [
        addr,
        //new Address("velkartest:qz7ulu4c25dh7fzec9zjyrmlhnkzrg4wmf89q7gzr3gfrsj3uz6xjceef60sd")
    ];
    ...
    // let outputs = [
    //     new velkar.TransactionOutput(300n, new velkar.ScriptPublicKey(0, keypair3.publicKey)),
    //     {
    //         value: 300n,
    //         scriptPublicKey : new velkar.ScriptPublicKey(0, keypair3.publicKey)
    //     },
    // ];
